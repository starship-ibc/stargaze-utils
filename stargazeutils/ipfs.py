...
class IpfsClient:
    def __init__(self, ipfs_root: str = "https://stargaze.mypinata.cloud"):
        self.ipfs_root = ipfs_root.strip("/")

    def ipfs_to_http(self, ipfs_url: str) -> str:
        ...
        return f"{self.ipfs_root}/ipfs/{root_hash}/{path}"

    def get(
        self, ipfs_url: str, max_retries: int = 10, retry_delay: float = 0.5
    ) -> requests.Response:
        ...
        while count <= max_retries:
            http_url = self.ipfs_to_http(ipfs_url)
